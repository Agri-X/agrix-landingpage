...
function Feature() {
  ...
  return (
    <div className="w-full py-20 lg:py-40">
      <div className={`container mx-auto ${isMobile ? 'w-[90%]' : ''}`}>
        <div className="flex gap-4 py-20 lg:py-40 flex-col items-start">
          ...
          <div className="flex gap-10 pt-12 flex-col w-full">
            <div className={`grid ${isMobile ? '' : 'grid-cols-2'} items-start lg:grid-cols-3 gap-10`}>
              <div className="flex flex-row gap-6 w-full items-start">
                <Check className="w-4 h-4 mt-2 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="font-bold">Finetuned AI exclusively for Agriculture</p>
              ...
              <div className="flex flex-row gap-6 items-start">
                <Check className="w-4 h-4 mt-2 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="font-bold">Domain Knowledge</p>
                  <p className="text-muted-foreground text-sm">
              ...
              <div className="flex flex-row gap-6 items-start">
                <Check className="w-4 h-4 mt-2 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="font-bold">Intuitive</p>
                  <p className="text-muted-foreground text-sm">
              ...
              <div className="flex flex-row gap-6 w-full items-start">
                <Check className="w-4 h-4 mt-2 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="font-bold">Enterprise-grade privacy and security</p>
                  <p className="text-muted-foreground text-sm">
              ...
              <div className="flex flex-row gap-6 items-start">
                <Check className="w-4 h-4 mt-2 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="font-bold">Break down organizational silos</p>
                  <p className="text-muted-foreground text-sm">
              ...
              <div className="flex flex-row gap-6 items-start">
                <Check className="w-4 h-4 mt-2 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="font-bold">Unlock Growth</p>
                  <p className="text-muted-foreground text-sm">
